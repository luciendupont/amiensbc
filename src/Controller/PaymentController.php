...
class PaymentController extends AbstractController
{
    ...
    public function stripeCheckout($reference): RedirectResponse
    {
        ...
        if ($totalInCents <= 0) {
            ...
            return $this->redirectToRoute('payment_error', ['reference' => $commande->getReference()]);
        }

        Stripe::setApiKey('sk_test_51N0iZNFPaCkpFiEQttCloECeEN4D0G0JTO4KQgQuyGRFYWmqvRxMIFWepPVZaQnIklKcYIeqW6k61mDCvqgZomwl00wEVu0pyy');
    ...
    {
        // Gérer l'erreur ici (par exemple, afficher une page d'erreur)
