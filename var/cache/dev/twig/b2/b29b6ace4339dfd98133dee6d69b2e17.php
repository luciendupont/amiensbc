...
/* bp/index.html.twig */
class __TwigTemplate_b8b0ea23f87700c1f452e7995ac4e874 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<a href=\"";
            // line 20
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("cart_add", ["id" => twig_get_attribute($this->env, $this->source, $context["forme2"], "id", [], "any", false, false, false, 20)]), "html", null, true);
            echo "\" class=\"btn btn-dark\">Prendre ma licence </a> 
...
";
    ...
    {
        return array (  121 => 20,  116 => 18,  112 => 17,  108 => 16,  101 => 12,  96 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"card mb-3 \" with=\"auto\">
     <div class=\"card-body\"> <div class=\"row align-items-center\">
       ...
       <div class=\"col-4\" ></div>
          ...
          <button type=\"button\" class=\"btn btn-light\" li class=\"nav-item\">
\t\t\t<a href=\"{{path('cart_add',{'id':forme2.id})}}\" class=\"btn btn-dark\">Prendre ma licence </a> 
...
{% endfor %}
{% endblock %}
", "bp/index.html.twig", "/home/lulu/Bureau/mode/stage/templates/bp/index.html.twig");
    }
}
