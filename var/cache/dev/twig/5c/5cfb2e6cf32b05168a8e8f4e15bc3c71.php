...
class __TwigTemplate_e5734e1abd4d1a035605931f1ac5229e extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        if (((isset($context["methode"]) || array_key_exists("methode", $context) ? $context["methode"] : (function () { throw new RuntimeError('Variable "methode" does not exist.', 50, $this->source); })()) == "stripe")) {
            ...
            if (array_key_exists("commande", $context)) {
                ...
                // line 53
                echo twig_escape_filter($this->env, twig_number_format_filter($this->env, (isset($context["total"]) || array_key_exists("total", $context) ? $context["total"] : (function () { throw new RuntimeError('Variable "total" does not exist.', 53, $this->source); })()), 2, ",", "."), "html", null, true);
                echo "€</button>
                            </form>
                        ";
            } else {
...
";
    ...
    {
        return array (  192 => 59,  189 => 58,  185 => 56,  179 => 53,  174 => 52,  171 => 51,  169 => 50,  163 => 47,  159 => 45,  146 => 38,  138 => 33,  132 => 30,  122 => 25,  117 => 22,  114 => 21,  109 => 20,  107 => 19,  101 => 16,  98 => 15,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
                ...
                <div class=\"mt-4 text-center\">
                    {% if methode =='stripe' %}
                        {% if commande is defined %}
                            <form method=\"POST\" action=\"{{ path('app_stripe_charge', {reference:commande.reference}) }}\">
...
{% endblock %}
", "commande/recap.html.twig", "/home/lulu/Bureau/mode/stage/templates/commande/recap.html.twig");
    }
}
