...
/* ba/index.html.twig */
class __TwigTemplate_4fe89f5150f07e8897cc0ef022cadc8c extends Template
{
    private $source;
    private $macros = [];
     ...
     <div class=\"card-body\"> <div class=\"row align-items-center\">
       ...
       <div class=\"col-4\" ></div>
          ...
          <button type=\"button\" class=\"btn btn-light\" li class=\"nav-item\">
                    ...
                    {% if forme1.prix > 0 %}
\t\t\t\t\t<a href=\"{{path('cart_add',{'id':forme1.id})}}\" class=\"btn btn-dark\">
                        Prendre ma licence
                    </a> 
                {% endif %}
                {% if forme1.prix < 0  %}
...
", "ba/index.html.twig", "/home/lulu/Bureau/mode/stage/templates/ba/index.html.twig");
    }
}
