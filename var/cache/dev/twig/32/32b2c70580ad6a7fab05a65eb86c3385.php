...
class __TwigTemplate_e3b460eaaab75b2af063ce36a26db11b extends Template
{
   ...
   <div class=\"justify-content-center col-4\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["formedeboxe"]) {
            ...
            // line 21
            echo "                        ";
            $context["payer"] = twig_get_attribute($this->env, $this->source, (isset($context["commande"]) || array_key_exists("commande", $context) ? $context["commande"] : (function () { throw new RuntimeError('Variable "commande" does not exist.', 21, $this->source); })()), "total", [], "any", false, false, false, 21);
            // line 22
            echo "                    <form id='checkout-form' method='post'
                        action=\"";
            // line 23
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_stripe_charge", ["reference" => twig_get_attribute($this->env, $this->source, (isset($context["commande"]) || array_key_exists("commande", $context) ? $context["commande"] : (function () { throw new RuntimeError('Variable "commande" does not exist.', 23, $this->source); })()), "reference", [], "any", false, false, false, 23)]), "html", null, true);
            echo "\">
            ...
            // line 29
            echo twig_escape_filter($this->env, (isset($context["total"]) || array_key_exists("total", $context) ? $context["total"] : (function () { throw new RuntimeError('Variable "total" does not exist.', 29, $this->source); })()), "html", null, true);
            echo "€
                        </button>
...
";
    ...
    {
        return array (  160 => 42,  149 => 33,  139 => 29,  130 => 23,  127 => 22,  124 => 21,  121 => 20,  116 => 19,  113 => 18,  104 => 15,  98 => 11,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}", "stripe/index.html.twig", "/home/mary/Documents/amiensbc10/templates/stripe/index.html.twig");
    }
}
